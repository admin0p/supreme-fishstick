...
type ACK_FRAME struct {
	...
	StreamId      int32                  `protobuf:"varint,1,opt,name=streamId,proto3" json:"streamId,omitempty"`   // stream identifier
	AckStatus     bool                   `protobuf:"varint,2,opt,name=ackStatus,proto3" json:"ackStatus,omitempty"` // true for success, false for failure
...
type ERROR_FRAME struct {
	...
	Code          int32                  `protobuf:"varint,5,opt,name=code,proto3" json:"code,omitempty"`                // error code
	StreamId      int32                  `protobuf:"varint,6,opt,name=streamId,proto3" json:"streamId,omitempty"`        // stream identifier
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_GenericFrames_proto_rawDesc = "" +
	"\n" +
	"\x19proto/GenericFrames.proto\x12\tDataFrame\"E\n" +
	"\tACK_FRAME\x12\x1a\n" +
	"\bstreamId\x18\x01 \x01(\x05R\bstreamId\x12\x1c\n" +
	"\tackStatus\x18\x02 \x01(\bR\tackStatus\"\xab\x01\n" +
	...
	"\x05stack\x18\x04 \x01(\tR\x05stack\x12\x12\n" +
	"\x04code\x18\x05 \x01(\x05R\x04code\x12\x1a\n" +
	"\bstreamId\x18\x06 \x01(\x05R\bstreamId\"\xf5\x01\n" +
